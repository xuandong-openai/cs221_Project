...
def loadImages():
    ...
    images["enemy1"] = pygame.transform.scale(images["enemy1"], (80, 80))
    images["enemy2"] = pygame.image.load("files/enemy_2.png").convert_alpha()
    images["enemy2"] = pygame.transform.scale(images["enemy2"], (80, 80))
    images["enemy3"] = pygame.image.load("files/enemy_3.png").convert_alpha()
    images["enemy3"] = pygame.transform.scale(images["enemy3"], (80, 80))
    ...
    images["background"] = pygame.transform.scale(images["background"], (640, 640))
    ...
    images["gameover"] = pygame.transform.scale(images["gameover"], (640, 640))
    ...
    images["introImage"] = pygame.transform.scale(images["introImage"], (640, 640))
